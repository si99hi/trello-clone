  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow border border-gray-100">
        <h1 className="text-2xl font-bold text-[#172B4D] mb-2">Reset password</h1>
        <p className="text-sm text-[#5E6C84] mb-6">Use the OTP sent to your email to reset your password.</p>
